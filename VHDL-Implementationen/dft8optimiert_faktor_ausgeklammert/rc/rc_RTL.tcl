...
set hdlFiles		[list constants.vhdl datatypes.vhdl multiplication.vhdl read_input_matrix.vhdl read_twiddle_matrix.vhdl TopLevelEntity.vhdl];# All HDL files
set basename		twiddle_matrix	;# name of toplevel module
