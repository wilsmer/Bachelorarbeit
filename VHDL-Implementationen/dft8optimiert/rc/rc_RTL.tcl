...
set hdlFiles		[list constants.vhdl datatypes.vhdl functions.vhdl dft8optimiert.vhdl dft8_optimiert_top.vhdl];# All HDL files
set basename		dft8optimiert_top;# name of toplevel module
set savePath		{./}	;# Save created Files here
set runName 		syn		;# name appended to output files

set hdl_vhdl_preferred_architecture {arch};
