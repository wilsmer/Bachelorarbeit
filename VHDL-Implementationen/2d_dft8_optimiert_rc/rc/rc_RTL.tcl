...
set hdlFiles		[list constants.vhdl datatypes.vhdl dft8optimiert_rc.vhdl dft8optimiert_top_rc.vhdl];# All HDL files
set basename		dft8optimiert	;# name of toplevel module
