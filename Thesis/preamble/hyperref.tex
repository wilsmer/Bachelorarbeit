...
%	    pdfstartview=	fit,			% Fit size when opening pdf
	    pdfpagelabels=	true,			% true = Roemische Zahlen usw werden dargestellt, false= fortlaufende nummerierung
	    pdftex=		true,
	    pdfsubject={Chipimplementation einer 2D-DFT für die Auswertung eines Sensorarrays},
	    pdftitle={Bachelorthesis im Fachbereich Elektrotechnik \& Informatik an der HAW-Hamburg},
	    pdfauthor={Thomas Lattmann}	    
	   ]{hyperref}
