...
\newabbreviation{ams}{AMS}{Austria Microsystems AG}
...
\newabbreviation{isar}{ISAR}{\textit{Signalverarbeitung für integrated Sensor-Arrays basierend auf dem Tunnel-Magnetoresistiven Effekt	 für den Einsatz in der Automobilelektronik}}

\newabbreviation{ft}{FT}{Fouriertransformation}
\newabbreviation{fft}{FFT}{Fast Fouriertransformation}

\newabbreviation{gmr}{GMR}{gigantischer magnetoresistiver Effekt}
\newabbreviation{gmr2}{GMR}{gigantischen magnetoresistiven Effekt}
