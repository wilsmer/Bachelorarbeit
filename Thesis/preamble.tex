\input{preamble/documentclass_schriftart.tex}
...
\input{preamble/glossar.tex}
\input{preamble/abkuerzungen.tex}
\input{preamble/hyperref.tex}
\input{preamble/listings.tex}
\input{preamble/lokalisation.tex}
\input{preamble/literatur.tex}
...
% Symbolverzeichnis erzeugen - lade dazu mit \include{symbolpage} das Verzeichnis 
%\usepackage[
