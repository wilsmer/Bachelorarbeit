...
%  \end{table}
 ...
 optimiert aus. Eine Multiplikation unter Anwendung des Wallace-Tree könnte die Anzahl der Gatter, insbesondere der hintereinander geschlteten reduzieren und so die Berechnung
