...
beschrieben. Es wird also erst die 1D-DFT berechnet und die sich daraus ergebende Matrix $F_1$ (Abb. \ref{eq:matrix_F1}) wird anschließend mit der Twiddlefaktor-Matrix $W$ 
