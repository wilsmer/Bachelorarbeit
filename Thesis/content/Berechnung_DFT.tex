...
\end{equation}
berechnet werden, wobei N die Anzahl der Elemente je Zeile bzw. Spalte ist. Bei genauer Betrachtung fällt auf, dass sie identisch mit ihrer Transponierten ist.
...
Es wird also erst die 1D-DFT berechnet und die sich daraus ergebende Matrix $X^*$ (Abb. \ref{pic:1D-DFT_als_Matrixmultiplikation}) wird anschließend mit der Twiddlefaktor-Matrix $W$ 
