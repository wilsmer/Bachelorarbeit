...
\section{Gate-Report des 13 Bit Konstantenmultiplizierers}
 \lstinputlisting[language={}, caption={RC Gate-Report des Konstanten multiplizierers}, label=src:rc_gate_report_KonstMult]{../VHDL-Implementationen/KonstMult/VERILOG/konstantenmultiplizierer_syn_cell.rep}
\section{Gate-Report des 13 Bit Multiplizierers}
 \lstinputlisting[language={}, caption={RC Gate-Report des Multiplizierers}, label=src:rc_gate_report_Mult]{../VHDL-Implementationen/Multiplikation/VERILOG/multiplizierer_syn_cell.rep} 
 \section{Gate-Report des 12 Bit Addierers}
 \lstinputlisting[language={}, caption={RC Gate-Report des 12 Bit Addierers}, label=src:rc_gate_report_Addierer]{../VHDL-Implementationen/Addierer/VERILOG/Addierer_Top_syn_cell.rep}
 \section{Gate-Report des 13 Bit Negierers}
 \lstinputlisting[language={}, caption={RC Gate-Report des 13 Bit Negierers}, label=src:rc_gate_report_Negierer]{../VHDL-Implementationen/Negierer/VERILOG/negierer_top_syn_cell.rep}
 \section{Gate-Report der 2D-DFT}
 \lstinputlisting[language={}, caption={RC Gate-Report der 2D-DFT}, label=src:rc_gate_report_2D-DFT]{../VHDL-Implementationen/2d_dft8_optimiert_rc/VERILOG/dft8optimiert_syn_cell.rep}
 ...
 \lstinputlisting[language=tcl, caption={Dauer der Simulation}, label=src:simulationsdauer]{Skripte/Shell/simulationTime.tcl}
 \section{Matlab-Skript zur Berechnung der Referenzwerte und Vergleich der Ergebnisse}
 \lstinputlisting[language=matlab, caption={Berechnung der Differenzen der DFT in Matlab und VHDL}, label=src:binMat2decMat.m]{Skripte/Matlab/VHDL_DFT_Vergleich.m}
