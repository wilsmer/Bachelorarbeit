...
8x8-DFT der klare Favorit, welcher im folgenden Abschnitt genauer betrachtet werden soll.
 ...
 Werte, weniger realistisch erscheint.
...
\vspace{0.5cm}
 ...
 zusammengesetzt. Gemäß der Definition für nicht triviale Werte aus Abschnitt \ref{sec:BewertungVerschiedenerGroessen} zählt ausschließlich der letztgenannte zu diesen.
...
\vspace{0.5cm}
 ...
 Für die übrigen vier Zeilen gelten die bisherigen Boebachtungen nicht oder nur teilweise, weshalb sie nicht zur ersten Gruppe gezählt werden können.
 ...
 Eine besondere Eigenschaft ist, dass nicht triviale Multiplikationen Real- und Imaginärteil zumindest vom Betrag her identisch sind.
