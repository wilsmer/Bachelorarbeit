...
Anders als die \gls{dct} hat die \gls{dft}

Die Beurteilung basiert auf dem Matlab-Skript aus Anhang \ref{src:dft_bewertung}. Die beiden Skripte unterscheiden sich
neben den Koeffizienten darin, dass die Twiddlefaktormatrizen der \gls{dft} komplex sind.
...
%  
 ...
 treten nicht auf. Alle übrigen Werte werden als nicht trivial betrachtet, da eine Multiplikation mit ihnen
 eine aufwändigere Berechnung bedeutet.
 ...
 der Einheitskreis in acht Teile geteilt wird und für beispielsweise $\frac{2\cdot\pi}{8}=\frac{\pi}{4}$ der Sinus- und Kosinuswert identisch sind. Darüberhinaus ist dies auch 
 ...
 Deshalb ist das berechnete Verhältnis von 3 in Tabelle \ref{tab:DFT-TwiddlefaktorMatrizenBewertung} in Wirklichkeit deutlich höher und übertrifft mit 7 die 12$\times$12
 ...
 Anfangs wurde angenommen, dass das 1er-Komplement eine gute Wahl sein könnte, da hierbei die Darstellung negativer Zahlen einzig durch Setzen des höchstwertigsten 
 Bit erfolgt. Auf diese Weise könnte immer das selbe Resultat für den Imaginär- wie für den Realteil verwendet werden, das Vorzeichen würde sich über eine 
 einfache XOR-Verknüpfung beider MSB ergeben.
 ...
 etwa dem der Bildung des 2er-Komplements. Aus diesem Grund wurde sich für dieses entschieden, da es deutlich verbreiteter ist und weitere Vorteile bringt wie 
 ...
 Werte aufteilen. Das lässt sich ausnutzen, um keine Negationen der Eingangs- und Zwischenwerte erfolgen muss. Darüber hinaus
 minimiert sich bei geschickter Anordnung das Risiko eines Überlaufs. Da zur Sicherheit dennoch nach jeder Addition oder Subtraktion
 ...
 \begin{figure}[!t]
  ...
  \captionof{figure}{Einheitskreis mit relevanten Werten der 8x8-DFT}
